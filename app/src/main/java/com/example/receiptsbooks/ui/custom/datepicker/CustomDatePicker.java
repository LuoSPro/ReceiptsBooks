package com.example.receiptsbooks.ui.custom.datepicker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mMDatePickerTitle;
    ...
    private void initView() {
        ...
        mMDatePickerTitle = mPickerDialog.findViewById(R.id.date_picker_tv_title);

        mPickerDialog.findViewById(R.id.date_picker_tv_confirm).setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.date_picker_tv_confirm) {
            if (mCallback != null) {
    ...
    public void setDatePickerTitle(int title){
        mMDatePickerTitle.setText(title);
    }
